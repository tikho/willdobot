...
def send_welcome(message):
    ...
    reminder_scheduler.add_job(remind, 'interval', [message.chat.id], minutes=random_time()%60)
...
def remind(chat_id):
    ...
    reminder_scheduler.add_job(remind, 'interval', [chat_id], minutes=random_time()%60)
